            ...
            ?>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a class="image">
                                        <img class="fit-image " src="assets/images/rent_products/<?php echo $data['image']; ?>" alt="Product" onClick="window.open(this.src)" />
                                    </a>
                                ...
                                <div class="content">
                                    ...
                                    <span class="price">
                                            <span class="new">Rs.<?php echo  $data['price']; ?></span>
