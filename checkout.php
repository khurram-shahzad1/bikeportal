                              ...
                              while($row_cart = mysqli_fetch_array($run_cart)){
                               ...
                               $cid = $row_products['c_id'];   
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="cart-product-total text-end pe-0"><span class="amount">Rs.<?php echo $sub_total; ?></span></td>
                                    </tr>
                                    <?php } } ?>
                                </tbody>
                                <!-- Table Body End -->
                                ...
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td class="text-end pe-0"><span class="amount">Rs.<?php echo $total; ?></span></td>
                                    </tr>
                                    <tr class="order-total">
                                        <th class="text-start ps-0">Order Total</th>
                                        <td class="text-end pe-0"><strong><span class="amount">Rs.<?php echo $order_total; ?></span></strong></td>
                                    </tr>
                                </tfoot>
                                <!-- Table Footer End -->
