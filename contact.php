            ...
            <div class="row m-b-n50">
                ...
                <div class="col-12 col-lg-6 m-b-50 order-1 order-lg-2" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="contact-content">
                        <p>We worked on designing a system that manages the rental process imported bikes and their asscesories from start to finish, you can also sell or purchase bikes and their parts and you also give bikes on rent in all over Pakistan.</p>
                        <address class="contact-block">
                            <ul>
                                <li><i class="fa fa-fax"></i> Pakistan</li>
                                <li><i class="fa fa-phone"></i> <a href="tel:123-123-456-789">+920000000</a></li>
                                <li><i class="fa fa-envelope"></i> <a href="mailto:demo@example.com">arslanrajpoot7@example.com </a></li>
                            </ul>
                        </address>
