                ...
                <div class="col-12 col-sm-6 col-lg-1 m-b-40" data-aos="fade-up" data-aos-duration="1400">
                    ...
                    <div class="col-12 col-sm-6 col-lg-5 m-b-40" data-aos="fade-up" data-aos-duration="1000">
                        <div class="single-footer-widget">
                            ...
                            <p class="desc-content">Imported Bikes selling purchasing and rental system</p>
                            <!-- Soclial Link Start -->
            ...
            <div class="mobile-menu-inner-wrapper">
                ...
                <div class="mt-auto bottom-0">
                    ...
                    <ul class="contact-links">
                        <li><i class="fa fa-phone"></i><a href="#"> +9230000000</a></li>
                        <li><i class="fa fa-envelope"></i><a href="#"> arslanrajpoot7@example.com</a></li>
